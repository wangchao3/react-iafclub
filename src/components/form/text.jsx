...
export default React.createClass({
    ...
    getInitialState: function() {
        return {errMsg: null, value: this.props.defaultValue};
    },
    ...
    getValue: function() {
        ...
        if ((!value || !value.trim()) && this.props.isRequired)
            return this.setState({
                'errMsg': '请填写' + this.props.label
            });
        if (value && this.props.regex && !this.props.regex.test(value))
            return this.setState({
        ...
        if (this.props.onValid) {
            const message = this.props.onValid(value);
            if (message)
                return this.setState({errMsg: message});
            }
        return value;
    }
})
