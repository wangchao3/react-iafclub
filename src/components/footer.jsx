...
export default React.createClass({
    ...
    render: function() {
        ...
        if (type === 'company') {
            return (
                <dl className="container footer_container">
                    <dt>
                        <Link to="/company/index" className={companyData.borrow ? 'active' : ''}>
                            <span className="iconfont">&#xe656;</span>
                            <span>借钱</span>
                        </Link>
                    </dt>
                    <dt>
                        <Link to="/my/home" className={companyData.home ? 'active' : ''}>
                            <span className="iconfont">&#xe63b;</span>
                            <span>账户</span>
                        </Link>
                    </dt>
        ...
        return (
            <dl className="container footer_container">
                <dt>
                    <Link to="/person/index" className={data.borrow ? 'active' : ''}>
                        <span className="iconfont">&#xe656;</span>
                        <span>借钱</span>
                    </Link>
                </dt>
                ...
                <dt>
                    <Link to="/my/home" className={data.home ? 'active' : ''}>
                        <span className="iconfont">&#xe63b;</span>
                        <span>我的</span>
                    </Link>
                </dt>
